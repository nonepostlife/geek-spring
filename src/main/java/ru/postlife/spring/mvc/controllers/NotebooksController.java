...
import ru.postlife.spring.mvc.entites.Students;
import ru.postlife.spring.mvc.service.NotebookService;
import ru.postlife.spring.mvc.service.StudentsService;
...
public class NotebooksController {
    ...
    @Autowired
    public void setStudentsService(NotebookService notebookService) {
    ...
    public Notebook showNotebookById(Model uiModel, @RequestParam int id) {
        return notebookService.getStudentById(id);
    }
